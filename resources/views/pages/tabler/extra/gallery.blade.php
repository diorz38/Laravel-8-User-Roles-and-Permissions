            ...
            <div class="row row-cards">
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/1b73704b282a8ec6.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/3d2998219313cd37.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/6ab3200b14549f8a.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/6d35d9a2bd6c63c2.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/8a26974ee6444acd.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/8c13ad59f739558c.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/8fdeb4785d2b82ef.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/9f36332564ca271d.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/35b88fc04a518c1b.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/36e273986ed577b8.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/75b555b99d5b38c4.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card card-sm">
                  <a href="#" class="d-block"><img src="{{ asset('static/photos/546fd146c83f428c.jpg') }}" class="card-img-top"></a>
                  <div class="card-body">
                    <div class="d-flex align-items-center">
